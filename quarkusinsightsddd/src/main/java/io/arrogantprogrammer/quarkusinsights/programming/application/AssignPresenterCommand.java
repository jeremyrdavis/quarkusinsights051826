...
/**
 * Command to assign a Person as a presenter (host) on an Episode.
 *
 * <p>Consumed by {@code AssignPresenterUseCase}. Idempotent at the
 * aggregate layer: assigning the same Person twice does not record a
 * second {@code PresenterAssigned} event.
 *
